...
var _cloning = require("./utils/cloning");
var _cloningDefault = parcelHelpers.interopDefault(_cloning);
var _skewed = require("./utils/skewed");
var _skewedDefault = parcelHelpers.interopDefault(_skewed);
var _animation = require("./utils/animation");
var _animationDefault = parcelHelpers.interopDefault(_animation);
var _clearTimeline = require("./utils/clearTimeline");
var _clearTimelineDefault = parcelHelpers.interopDefault(_clearTimeline);
class MarqueeContent extends HTMLElement {
    ...
    update() {
        ...
        if (this.firstElementChild) this.af = requestAnimationFrame(()=>{
            (0, _cloningDefault.default).call(this);
            (0, _animationDefault.default).call(this);
        });
    }
    init() {
        (0, _breakpointsDefault.default).call(this);
        (0, _skewedDefault.default).call(this);
        (0, _cloningDefault.default).call(this);
        (0, _animationDefault.default).call(this);
    }
    destroy() {
        cancelAnimationFrame(this.af);
        (0, _clearTimelineDefault.default).call(this);
...
exports.default = MarqueeContent;
if (!customElements.get("marquee-content")) customElements.define("marquee-content", MarqueeContent);

},{"./utils/breakpoints":"h6zhq","./utils/cloning":"fpGxz","./utils/skewed":"4NB8M","./utils/animation":"c1msf","./utils/clearTimeline":"98dqe","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"h6zhq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"fpGxz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function cloning() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"4NB8M":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function skewed() {
...
exports.default = skewed;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"c1msf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _clearTimeline = require("./clearTimeline");
var _clearTimelineDefault = parcelHelpers.interopDefault(_clearTimeline);
function animation() {
    if (this.timeline) (0, _clearTimelineDefault.default).call(this);
    this.MM.add(this.breakpoint, ()=>{
...
},{"./clearTimeline":"98dqe","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"98dqe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = clearTimeline;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}]},["chmSq","b9BDZ"], "b9BDZ", "parcelRequireb19d")
